...
const Header = () => {
  return (
    <header id='about' className="p-4 bg-black text-white">
      ...
      <div className=" flex items-center justify-center gap-4 md:flex-row flex-col relative">
        ...
        <motion.div className='h-10 w-10 text-center flex justify-center items-center bg-gradient-to-r from-[#DBA6F4] to-[#A981FE] rounded-full text-black relative group shadow-md'
          whileHover={{ scale: 1.2 }}
          whileTap={{ scale: 0.9 }}
          transition={{ type: "spring", stiffness: 400, damping: 17 }}
          >
        <a href="/BappaBarikResume.pdf" download="BappaBarikResume.pdf"><LuDownload size={24} color='black' />
        </a>
        <span 
              className='absolute p-1 bg-slate-200 rounded-lg hidden group-hover:flex items-center text-[10px] -right-24'>
              Download Resume
        </span>
        </motion.div>
        </div>
        ...
        <ul className="flex fixed md:right-5 right-1 flex-col gap-5 items-center justify-center z-10">
